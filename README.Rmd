...
This package has a few tangentially related functions to visualize and/or modify [brms](https://paul-buerkner.github.io/brms/index.html) models. It's a collection of functions I have been accumulating as I use [brms](https://paul-buerkner.github.io/brms/index.html) for my statistical analyses. So far the package has functions for:
